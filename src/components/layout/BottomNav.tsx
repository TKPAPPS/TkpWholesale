...
export function BottomNav() {
  ...
  return (
    // data-bottom-nav is a stable hook: the cart page measures this element's real height
    // (which includes the safe-area padding below) to park its mobile checkout bar directly
    // on top of it, instead of hardcoding a pixel offset that drifts with font scaling.
    <nav data-bottom-nav className="md:hidden fixed bottom-0 inset-x-0 z-30 bg-white border-t border-gray-100 shadow-[0_-1px_8px_0_rgba(0,0,0,0.05)] pb-[env(safe-area-inset-bottom)] print:hidden">
