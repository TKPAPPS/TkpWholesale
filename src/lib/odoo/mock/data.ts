...
export const MOCK_ORDER_DETAIL: OrderDetail = {
  ...
  lines: [
    ...
    { line_id: 1003, product_id: 24, template_id: 24, packaging_id: null, product_name: 'Seabass Fillet', product_name_he: 'פילה לברק', sku: 'FSH-SB', packaging_name: 'Box of 10 Kg', packaging_qty: 1, unit_qty: 10, uom: 'kg', qty_delivered: 10.42, qty_invoiced: 0, deliverable: true, weighed: true, price_unit: 780.00, price_subtotal: 8127.60, price_total: 8533.98 },
